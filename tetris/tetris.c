...
// Spawn a 7/8 de la pantalla, ajustado para alto de pieza
...
// --------------------------------------------------
// Dibuja todas las piezas en grid
// --------------------------------------------------
static void draw_grid(void) {
...
void wdt_c_handler(void) {
  ...
  if(!collided){ shapeRow=newRow; }
    ...
    draw_grid(); clear_full_rows(); pieceStoppedFlag=TRUE;
